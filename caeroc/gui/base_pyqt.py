...
class Ui_CalcDialog(object):
    def setupUi(self, CalcDialog):
        ...
        self.qpb_plot = QtWidgets.QPushButton(self.formFrame)
        self.qpb_plot.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.qpb_plot.setAutoFillBackground(False)
        self.qpb_plot.setObjectName("qpb_plot")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.qpb_plot)
    ...
    def retranslateUi(self, CalcDialog):
        ...
        self.qpb_plot.setText(_translate("CalcDialog", "Plot"))
